...
function addRow() {
    ...
    const newRowData = {
        ...
        "HỒ SƠ": trangThaiHoSo, // Gán nhãn trạng thái hồ sơ để đồng bộ qua Web2
...
// Hàm thực thi tiến trình gửi fetch API ngầm sau khi đã xác nhận
